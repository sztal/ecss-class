...
\begin{frame}[fragile]
    ...
    \only<+>{
        ...
        \begin{enumerate}
            ...
            \item Press \mintinline{bash}{File} and choose \mintinline{bash}{Open notebook...}
...
\begin{frame}[fragile]
    ...
    \only<4,6>{
        ...
        \begin{enumerate}
            \item<4,6> Press CMD and SPACE at the same time
            \item<4,6> Type Terminal and press RETURN (ENTER)
    ...
    \only<8,10,12>{
        ...
        \begin{enumerate}
            ...
            \item<10,12> Type \mintinline{bash}{bash ~/Downloads/Anaconda3-2019*.sh} in Terminal and press RETURN (ENTER)
            \item<12> Type \mintinline{bash}{jupyter notebook} in Terminal and press RETURN (ENTER) to open the Jupyter Notebook App
        \end{enumerate}
    }
    \only<9>{
    ...
    \only<14,16>{
        ...
        \begin{enumerate}
            ...
            \item<14,16> Double click on Anaconda3-2019.10-Windows-x86\_64.exe and follow the default installation
            \item<16> Type \mintinline{bash}{jupyter notebook} in Anaconda Prompt and press ENTER to open Jupyter Notebook
        \end{enumerate}
    }
    \only<15>{
